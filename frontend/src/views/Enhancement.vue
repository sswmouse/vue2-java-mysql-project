...
<template>
    <div class="enhancement-page">
        ...
        <div
            ...
            class="empty-tip"
        >
            <el-empty description="请选择角色以查看和编辑增幅配置">
                <el-icon
                    class="empty-icon"
                    size="60"
                >
...
<script>
import api from '@/api'
import AmplifyConfig from '@/components/AmplifyConfig.vue'
    ...
    methods: {
        ...
        async onCharacterChange(characterId) {
            ...
            try {
                ...
                this.amplifyData = data?.amplify || {}
            } catch (error) {
                console.error('加载增幅数据失败:', error)
                this.amplifyData = {}
            }
        },
        onSaved() {
